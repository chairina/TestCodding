...
namespace BusinessLogic.Applications
{
    public class SupplierApplication : ISupplierApplication
    {
        ...
        public bool Insert(SupplierVM supplierVM)
        {
            ...
            if (string.IsNullOrEmpty(supplierVM.Name) || string.IsNullOrWhiteSpace(supplierVM.Name)) // untuk mengecek inputan kosong/null
            {
                return false;
            }
            else
        ...
        public bool Update(int id, SupplierVM supplierVM)
        {
            ...
            else if (string.IsNullOrEmpty(supplierVM.Name) || string.IsNullOrWhiteSpace(supplierVM.Name)) // untuk mengecek inputan kosong/null
            {
                return false;
            }
            else
